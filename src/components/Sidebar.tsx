...
import Logo from '../images/logo/logo-white-border.png';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="1.5 3 20 20" width="18" height="18" strokeWidth={1.5} stroke="currentColor" >
