...
import { fetchQuestionBanks, deleteQuestionBank } from '../services/api';
...
const QuestionBanks = () => {
    ...
    const handleDeleteClick = (bankId: string, bankName: string) => {
        setBankToDelete({ id: bankId, name: bankName });
